...
class EMConfig:
    ...
    # Model Config
    input_dim = GeneralConfig.num_phys + GeneralConfig.num_species
    output_dim = GeneralConfig.num_species
    hidden_dim = 256
    window_size = 240
    ...
    gradient_clipping = 2
    pretrained_model_path = os.path.join(GeneralConfig.working_path, "weights/mlp_only.pth")
    save_model_path = os.path.join(GeneralConfig.working_path, "weights/mlp_only.pth")
